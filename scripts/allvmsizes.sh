...
sedcmd2="s/ResourceDisk.SwapSizeMB=0/ResourceDisk.SwapSizeMB=10240/g"
...
/usr/bin/wget --quiet "https://raw.githubusercontent.com/JanelleJames-devops/DTPSGH-v3stg/master/hdbinst.cfg"
